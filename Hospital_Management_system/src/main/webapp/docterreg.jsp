...
<div style="color:rgb(236, 224, 224);"><h2 >HospDBMS |Docter Registeration </h2></div>



<form action="DocterReg" method="get">
  
  <div class="container">
  <label for="uname" style="color:rgb(236, 224, 224);"><b>Docter ID</b></label>
    <input type="text" placeholder="Patient ID" name="pid" required>
  
    <label for="uname" style="color:rgb(236, 224, 224);"><b>Name</b></label>
	...
	<label for="numer" style="color:rgb(236, 224, 224);"><b>Degree</b></label>
    <input type="text" placeholder="Degree name" name="degree" required>
              
    <label for="numer" style="color:rgb(236, 224, 224);"><b>Specification</b></label>
    <input type="text" placeholder="Specification" name="Spe" required>
    
     
  </div>
  <span class="psw">Alredy have an account? <a href="docterlogin.jsp">Login</a></span>
